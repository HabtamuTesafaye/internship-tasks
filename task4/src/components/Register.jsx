...
const RegistrationPage = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (validateForm()) {
      ...
      localStorage.setItem('user', JSON.stringify(formData)); // Save the form data to localStorage
          ...
          <div className="row g-0">
            <div className="col-12 col-md-6 text-bg-primary">
              ...
              <div className="col-10 col-xl-8 py-3">
                ...
                <h2 className="h1 mb-4">Join Our E-Learning Community!</h2>
                <p className="lead m-0">Unlock your potential with our comprehensive courses and interactive learning experiences.</p>
              </div>
              </div>
            </div>
